 ...
 */
public class AnswerShakespeare extends Answers {
    ...
    private final static String API_URL="http://foaas.com/shakespeare/Chris/Renwick";

    public AnswerShakespeare() {
        super();
    }

    public AnswerShakespeare(ArrayList<String> answers) {
        mAnswers = answers;
    }
